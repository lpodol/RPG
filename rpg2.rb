beast_array = ["tiger", "snake","chameleon","walrus","saber-toothed tiger", "griffin", "banana", "warthog", "bloodthirsty duck"];
...
hero_object = {name: name,
  ...
  def flight(healthH,aliveH,aliveB,healthB,beast)
    ...
    if healthH <= 0
      ...
      if query == "N"
        flight(healthH,aliveH,aliveB,healthB,beast)
      elsif query == "Y"
